...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      <div className="w-full h-[1133px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
        {/* <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
          Download Resume
        </button> */}
        <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
          <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#4FABFF_0%,#FF6200_50%,#4FABFF_100%)] z-10" />
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl z-20">
              Border Magic
          </span>
        </button>
      </div>
